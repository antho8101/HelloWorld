...
export const CallToAction: React.FC = () => {
  return (
    <div className="bg-[rgba(97,83,189,1)] flex w-full items-center gap-[40px_140px] justify-center flex-wrap mt-20 px-20 rounded-[10px] border-[rgba(18,0,113,1)] border-solid border-[3px] max-md:max-w-full max-md:mt-10 max-md:px-5">
      <img
        loading="lazy"
      ...
      <div className="self-stretch flex min-w-60 flex-col items-stretch flex-1 shrink basis-[0%] my-auto max-md:max-w-full">
        ...
        <button className="bg-[rgba(254,207,196,1)] gap-2.5 text-base text-[#FF6A48] font-bold mt-10 px-5 py-2.5 rounded-[10px] border-[rgba(255,106,72,1)] border-solid border-2 w-fit">
          Join the community
        </button>
      </div>
    </div>
